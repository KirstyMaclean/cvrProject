...
d<- read.csv("d.txt", header=TRUE, sep="\t", quote="", na.strings=c("NA", "", "n/a"),encoding="UTF-8")
...
#removes cells that just contain numbers because of poorly formed XML
d$Center<-sub("20.*", " ", d$Center)
d$Center<-sub("1.*", " ", d$Center)
d$Center<-sub("2.*", " ", d$Center)
d$Center<-sub("3.*", " ", d$Center)
d$Center<-sub("4.*", " ", d$Center)
d$Center<-sub("5.*", " ", d$Center)
d$Center<-sub("6.*", " ", d$Center)
d$Center<-sub("7.*", " ", d$Center)
d$Center<-sub("8.*", " ", d$Center)
d$Center<-sub("9.*", " ", d$Center)
